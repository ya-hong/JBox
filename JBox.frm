...
Public Function rand(X As Integer) As Integer
    rand = Int(Rnd * X)
End Function


Public Sub Main()
    mxscore = Val(GetTXT("C:\Users\Public\Documents\box\mxscore"))
    ...
    Shape(0).Height = rand(1500) + 500
    Shape(1).Height = rand(1500) + 500
...
Public Sub chk()
    ...
    For i = 0 To 1
        ...
        If Not chk Then
            ...
            Call SetTXT(Str(mxscore), "C:\Users\Public\Documents\box\mxscore")
            Call Main
        End If
    Next i
...
Private Sub Form_Load()
    ...
    If Dir("C:\Users\Public\Documents\box\", vbDirectory) = "" Then
        MkDir ("C:\Users\Public\Documents\box\")
    End If
    If Dir("C:\Users\Public\Documents\box\mxscore") = "" Then
        CrtTXT ("C:\Users\Public\Documents\box\mxscore")
    End If
